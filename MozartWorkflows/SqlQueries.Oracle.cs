namespace MozartWorkflows
{
    ...
    {
        /// <summary>Oracle query strings (ODP.NET — uses : named parameter markers).</summary>
        public static class Oracle
        {
            ...
            public const string LoginUser =
                "SELECT id, username, email, passwordhash, salt, NVL(IsAdmin, 0) AS IsAdmin " +
            ...
            public const string InsertLoginAudit =
                ...
                "VALUES (:UserId, :Input, SYS_EXTRACT_UTC(SYSTIMESTAMP), :IP, :Agent, :Success, :Reason)";
        }
    }
}
